...
#define log_trace(file, line, ...) log_base(LOG_TRACE, file, line, __VA_ARGS__)
#define log_debug(file, line, ...) log_base(LOG_DEBUG, file, line, __VA_ARGS__)
#define log_info(file, line, ...)  log_base(LOG_INFO,  file, line, __VA_ARGS__)
#define log_warn(file, line, ...)  log_base(LOG_WARN,  file, line, __VA_ARGS__)
#define log_error(file, line, ...) log_base(LOG_ERROR, file, line, __VA_ARGS__)
#define log_fatal(file, line, ...) log_base(LOG_FATAL, file, line, __VA_ARGS__)
