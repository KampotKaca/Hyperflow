...
#define MAX_TEXTURES_IN_TEXTURE_PACK 4
...
#define RN_NUM_MAX_COLOR_ATTACHMENTS          8
#define RN_NUM_MAX_VERTEX_ATTRIBUTES          16
#define RN_NUM_MAX_TEXTURES_IN_LAYOUT         16
