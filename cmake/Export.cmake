...
#    endif ()
    ...
    add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD
            ...
            COMMAND ${CMAKE_STRIP} $<TARGET_FILE:${PROJECT_NAME}> -o "${EXPORT_DIR}/${EXECUTABLE_FOLDER}/$<TARGET_FILE_NAME:${PROJECT_NAME}>"
    ...
    if (WINDOWS)
        add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD
                COMMAND cmd /c "for %f in (\"$<TARGET_FILE_DIR:${PROJECT_NAME}>\\*.dll\") do copy /Y \"%f\" \"${EXPORT_DIR}/${EXECUTABLE_FOLDER}/\""
        )
    elseif (LINUX)
        add_custom_command(TARGET ${PROJECT_NAME} POST_BUILD
                COMMAND ${CMAKE_COMMAND} -E copy_if_different
                $<TARGET_FILE_DIR:${PROJECT_NAME}>/*.so
